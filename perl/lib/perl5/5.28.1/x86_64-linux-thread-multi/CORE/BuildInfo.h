...
#define ACTIVEPERL_VERSION      2801
#define ACTIVEPERL_SUBVERSION   0
#define ACTIVEPERL_CHANGELIST   " [cb03d3e0]"
...
#endif
#define PERLFILEVERSION		"5,26,3," STRINGIFY(ACTIVEPERL_VERSION) "\0"
#define PERLRC_VERSION		5,26,3,ACTIVEPERL_VERSION
